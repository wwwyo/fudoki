...
import type { Direction, DetailRow, DetailTable } from '@fudoki/report/budget/detail'
...
export { LEVELS, cell, levelCell } from '@fudoki/report/budget/detail'
import { expectedColumns } from '@fudoki/report/budget/detail'
