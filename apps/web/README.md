...
**年度ごとに何がどこまで取れているか**、COFOG の判断がどこで入りどう割れたか、そして明細。

⚠️ 年度の面を別に持つのは、**団体で畳んだ割合が年度の主張には使えない**ため
（名称の載った資料が一部の年度にしか無い団体では、合算が実態から離れる）。
統計カードと COFOG の節はどれも全年度の合算で、年度差はそこに現れない。
