{{ config(materialized = 'external', location = '../data/budget/datapackages/132195/revenue.csv', format = 'csv') }}
...
{% if budget_amount_is_year_scoped('132195', 'revenue') %}
  {{ exceptions.raise_compiler_error(
      '132195/revenue: 年度で割れた宣言がある。このモデルは宣言を段階として展開するので、'
