{{ config(materialized = 'external', location = '../data/budget/datapackages/132047/expenditure.csv', format = 'csv') }}
...
{% set amounts = var('budget_amounts')['132047']['expenditure'] %}
{% if amounts | length != 1 %}
  {{ exceptions.raise_compiler_error(
      '132047/expenditure: 予算段階が ' ~ amounts | length ~ ' 種類ある。'
